...
<section class="min-h-screen relative flex items-center justify-center px-4 hero-bg">
    <div class="max-w-3xl text-center z-10">
        ...
        <p class="text-md md:text-lg text-white/90 mb-8 leading-relaxed">
            Kami menyediakan berbagai komponen berkualitas tinggi, mulai dari prosesor mutakhir, kartu grafis, motherboard, hingga aksesori pendukung lainnya. Dengan koleksi yang terus diperbarui dan layanan pelanggan yang berdedikasi, CoreTI memastikan Anda mendapatkan pengalaman berbelanja yang mudah dan memuaskan. Dapatkan solusi hardware terbaik untuk meningkatkan kinerja dan produktivitas Anda hanya di CoreTI!
        </p>
        <a href="{{ route('about') }}" class="inline-block bg-white text-blue-600 font-semibold px-8 py-4 rounded-lg hover:bg-gray-100 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 uppercase">
            Discover More
        </a>
    </div>
</section>
...
<section class="py-16 px-4 bg-gray-50">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            ...
            <form action="{{ route('add_to_cart') }}" method="post" class="bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2 overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <input type="number" min="1" name="quantity" value="1" class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg mb-4 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none">
        ...
        <div class="text-center mt-12">
            <a href="{{ route('shop') }}" class="inline-block bg-orange-500 hover:bg-orange-600 text-white font-semibold px-8 py-4 rounded-lg transition-all duration-300 hover:shadow-lg hover:-translate-y-1 uppercase">
                Load More
            </a>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto">
        <div class="flex flex-col md:flex-row items-center gap-8">
            ...
            <div class="flex-1 bg-gray-50 p-8 rounded-lg">
                ...
                <a href="{{ route('about') }}" class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-4 rounded-lg transition-all duration-300 hover:shadow-lg hover:-translate-y-1 uppercase">
                    Read More
                </a>
            </div>
        </div>
...
<section class="py-16 px-4 bg-white border-t-4 border-gray-200">
    <div class="max-w-3xl mx-auto text-center">
        ...
        <a href="{{ route('contact') }}" class="inline-block bg-white border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white font-semibold px-8 py-4 rounded-lg transition-all duration-300 hover:shadow-lg hover:-translate-y-1 uppercase">
            Contact Us
        </a>
    </div>
</section>
