...
<section class="py-16 px-4 bg-gray-50">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="space-y-6 mb-12">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 flex flex-col md:flex-row items-center gap-6 hover:shadow-xl transition-all duration-300">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 max-w-2xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                <a href="{{ route('shop') }}" class="flex-1 bg-orange-500 hover:bg-orange-600 text-white font-semibold py-4 rounded-lg text-center transition-all duration-300 hover:shadow-lg uppercase">
                    Continue Shopping
                </a>
                <a href="{{ route('checkout') }}" class="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 rounded-lg text-center transition-all duration-300 hover:shadow-lg uppercase {{ ($grand_total > 1) ? '' : 'opacity-50 cursor-not-allowed' }}" {{ ($grand_total > 1) ? '' : 'onclick="return false;"' }}>
                    Proceed to Checkout
                </a>
            </div>
        </div>
