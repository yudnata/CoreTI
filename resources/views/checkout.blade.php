...
<section class="py-16 px-4 bg-gray-50">
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <form action="{{ route('place_order') }}" method="post" class="bg-white rounded-lg shadow-lg p-8">
                @csrf
                ...
                <button type="submit" class="w-full mt-8 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 rounded-lg transition-all duration-300 hover:shadow-lg hover:-translate-y-1 uppercase text-lg">
                    Order Now
                </button>
            </form>
        </div>
