...
@section('title', 'Register - CoreTI')

@section('content')
<div class="max-w-md mx-auto">
    <form action="{{ route('register') }}" method="post"
        class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-10 border border-white/20 animate-slide-up">
        @csrf

        <div class="text-center mb-6">
            <h3 class="text-4xl font-bold text-gray-800 mb-2">Create Account</h3>
        </div>
        ...
        <button type="submit"
            class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 rounded-xl transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 active:scale-95">
            Create Account
        </button>
