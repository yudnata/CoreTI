...
<section class="py-16 px-4">
    <div class="max-w-7xl mx-auto">
        <div class="flex flex-col md:flex-row items-center gap-12 mb-16">
            <div class="flex-1">
                <img src="{{ asset('assets/images/about-img.jpg') }}" alt="About CoreTI" class="rounded-2xl shadow-2xl w-full">
            </div>
            <div class="flex-1">
                <h3 class="text-4xl font-bold text-gray-800 mb-6 uppercase">Why Choose Us?</h3>
                <p class="text-lg text-gray-600 leading-relaxed mb-6">
                    CoreTI adalah toko hardware komputer terpercaya di Bali yang menyediakan berbagai komponen berkualitas tinggi untuk kebutuhan teknologi Anda. Kami berkomitmen untuk memberikan produk terbaik dengan harga yang kompetitif.
                </p>
                <p class="text-lg text-gray-600 leading-relaxed mb-6">
                    Dengan pengalaman bertahun-tahun di industri teknologi, kami memahami kebutuhan pelanggan kami. Tim ahli kami siap membantu Anda memilih komponen yang tepat untuk build PC impian Anda.
                </p>
                ...
                <a href="{{ route('contact') }}" class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-4 rounded-lg transition-all duration-300 hover:shadow-lg hover:-translate-y-1 uppercase">
                    Contact Us
                </a>
            </div>
        </div>
