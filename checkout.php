...
if (isset($_POST['order_btn'])) {
    ...
    $cart_total = 0;
    $cart_products = []; // Inisialisasi sebagai array kosong
...
<body>
    ...
    <section class="display-order">
        ...
        ?>
                <p> <?php echo $fetch_cart['name']; ?> <span>(<?php echo 'Rp ' . number_format($fetch_cart['price']) . '/- x ' . $fetch_cart['quantity']; ?>)</span> </p>
        <?php
            }
        } else {
